...
def plot_score_comparisons(experiment_path, consistencies, scores_certain, scores_full, std_certain, std_full, scores_retrain_maj, std_retrain_maj,
                           scores_retrain_plugin, std_retrain_plugin, max_possible_score, existing_score, crop_y=False):
    """
    ...
    l3 = ax.plot(consistencies, scores_certain, color='blue',
    ...
    l4 = ax.plot(consistencies, scores_full, color='lightgreen',
    ...
    l5 = ax.plot(consistencies, scores_retrain_maj, color='light_gray',
    ...
    l6 = ax.plot(consistencies, scores_retrain_plugin, color='red',
